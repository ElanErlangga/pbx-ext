...
export class KomikStation extends MangaStream {
    ...
    override configureSections(): void {
        ...
        this.homescreen_sections['popular_today'].selectorFunc = ($: CheerioStatic) => $('div.bsx', $('h2:contains(Yang Lagi Trending!)')?.parent()?.next())
